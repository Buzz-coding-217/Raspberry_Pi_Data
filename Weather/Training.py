...
def extract_features(image):
    ...
    image = image.resize((128, 128))  # Increased size to 128x128 pixels
...
pca = PCA(n_components=100)  # Increased to 100 components
...
# Train model
model = RandomForestClassifier(n_estimators=1000, random_state=0, n_jobs=-1)  # Increased to 1000 trees
